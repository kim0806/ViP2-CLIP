        ...
        for cls_name in self.CLSNAMES:
            ...
            for phase in self.phases:
                ...
                for idx in range(cls_data_phase.shape[0]):
                    ...
                    normal_name = os.listdir(os.path.join(self.root, cls_name, 'Data', 'Images', 'Normal'))[0]
                    info_img = dict(
                        img_path=data[3],
                        normal_path=f'{cls_name}/Data/Images/Normal/{normal_name}',
...
if __name__ == '__main__':
    runner = VisASolver(root='/ssd2/yangziteng/anomaly_detect/data/visa')
    runner.run()
