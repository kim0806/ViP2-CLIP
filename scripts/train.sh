#!/bin/bash
export CODE_DIR=/mnt/afs/yangziteng/project/project/vipclip/
export PYTHONPATH=$CODE_DIR:${PYTHONPATH:-}

device=0
base_dir='visa_train_agg'
train_script=/mnt/afs/yangziteng/project/project/vipclip/train.py
test_script=/mnt/afs/yangziteng/project/project/vipclip/test.py

save_dir=/mnt/afs/yangziteng/project/project/vipclip/saves/${base_dir}
output=/mnt/afs/yangziteng/project/project/vipclip/logs/visa_train.log
...
for topk in "${topks[@]}"; do 
    echo "===== TRAIN START: topk=${topk} $(date) =====" >> ${output}
...
for topk in "${topks[@]}"; do 
    echo "===== TEST START: epoch ${epoch} topk=${topk} $(date) =====" >> ${output}
